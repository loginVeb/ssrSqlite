...
// Читай весь проект читай как тебе удобна можешь по честям если фаил большой неспрашивай разрешения на чтение файлов, только спрашивай разрешение на изменение кода
...
// буду делать всё постепено не спеши делай толь то что говорю не больше а то я попросил создать файлы и всё а ты сразу всё туда записал
